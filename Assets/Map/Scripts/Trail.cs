...
// Copied from http://wiki.unity3d.com/index.php/OptimizedTrailRenderer
public class Trail : MonoBehaviour 
{
	...
	void Awake ()
	{
		...
		trailObj.GetComponent<MeshRenderer> ().sortingLayerName = "ParticleLayer";
	}
	...
	void Update ()
	{
		...
		if(pointCnt < 2)
		{
			trailObj.GetComponent<MeshRenderer>().enabled = false;
			return;
		}
		trailObj.GetComponent<MeshRenderer>().enabled = true;
